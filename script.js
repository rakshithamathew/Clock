...
function settime() {
    ...
    if(a==hourr){
        document.getElementById("right-container-image").style.backgroundImage="(images/window.png)";
        document.getElementById("right-container-text").innerHTML="  Wake up..it's breakfast Time!"
        div_var1 =1;
    }
    else if(b==hourr){
        document.getElementById("right-container-image").style.backgroundImage="url(images/lunch_image.svg)";
        document.getElementById("right-container-text").innerHTML="  Let's have some Lunch together!"
        div_var2 =1;
    }
    else if(c==hourr){
        document.getElementById("right-container-image").style.backgroundImage="url(images/sleep.png)";
        document.getElementById("right-container-text").innerHTML="  Nap Time...Sleep well!!"
        div_var3 = 1;
    }
    makeDive();
}